        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-14 lg:grid-cols-[1.4fr_0.8fr] lg:gap-24">
          ...
          <div className="flex flex-col justify-center">
            <p className="text-p max-w-md leading-relaxed text-muted-foreground">
              Calacot is a premier design and construction company specializing
              in high-end residential projects, delivering exceptional spaces
              that embody our clients&apos; unique visions.
            </p>
