  ...
  return (
    <section className="relative isolate flex min-h-[calc(100svh-4rem)] overflow-hidden bg-brand-black text-brand-white">
      ...
      {/* 
        ...
        Adjust height and background stops to match the background color of your next section.
      */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 bottom-0 z-10 h-48 bg-gradient-to-b from-transparent via-brand-black/70 to-brand-black sm:h-64 lg:h-80"
      />
